...
import {mapStateToProps,mapDispatchToProps} from "./mapStore"
 class Car extends Component {
    render() {
        ...
        console.log(carList,'aaaaaaaaaaaaaa')
        return (
            <CarWrapper>
                        ...
                        <div className='carContent'>
                            {
                                carList.map((item,index)=>(
                                    ...
                                    <div className='flex-box'>
                                        ...
                                        <div data-v-66abceb7="" className="flex-box-right"> 去凑单
                                    ...
                                    <div className='flex-box1'>
                                        <input type='radio' className='radio-icon'></input>
            ...
            <div className='cart-bottom'>
                <div className='cart-bottom-information'>
                    ...
                    <div className='information'>
                        <div>合计:<span>￥28.50</span></div>
                        <div>已省￥0.00<span>(以免运费)</span></div>
                    </div>
                </div>
                <div className='cart-bottom-action'>去结算</div>
            </div>
            </CarWrapper>
        )
    }
